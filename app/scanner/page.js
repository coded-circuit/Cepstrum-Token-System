    ...
    <div className="min-h-screen bg-black font-sans text-zinc-300 selection:bg-yellow-500/30 p-4 md:p-8 flex items-center justify-center">
      <div className="w-full max-w-md">
        ...
        {scanState === 'success' && guestData && !showFoodSelector && (
          <div className="bg-[#0a0a0a] border border-emerald-900/50 rounded-sm p-8 text-center shadow-[0_0_40px_rgba(16,185,129,0.05)]">
            ...
            <div className="mt-6">
               <span className="text-[10px] text-zinc-600 font-mono uppercase tracking-widest">Auto-resetting in 4s...</span>
            </div>
          </div>
        )}
        ...
        {scanState === 'already-dined' && guestData && (
          <div className="bg-[#0a0a0a] border border-orange-900/50 rounded-sm p-8 text-center shadow-[0_0_40px_rgba(249,115,22,0.05)]">
            ...
            <span className="text-[10px] text-zinc-600 font-mono uppercase tracking-widest">Auto-resetting in 3s...</span>
          </div>
        )}
